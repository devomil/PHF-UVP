...
export const VIDEO_PROVIDERS: Record<string, VideoProvider> = {
  ...
  'runway-aleph-2': {
    ...
    description: 'Frame-based video editing — edit one frame and Aleph 2.0 transforms the entire clip',
    costPerSecond: 0.09,
    maxDuration: 10,
    family: 'runway',
    tier: 'premium',
    specialization: 'video-editing',
    strengths: ['Frame-consistent video editing', 'Style transformation', 'Lighting corrections', 'Cinematic re-styling'],
    weaknesses: ['Requires existing video clip', 'Premium pricing'],
    bestFor: ['video-editing', 'style-transfer', 'lighting-correction', 'cinematic', 'restyle'],
    specialties: ['Frame-based editing', 'Style transformation', 'Consistent clip-level changes'],
    limitations: ['Requires a source video clip', 'Direct Runway API required'],
    visualCategory: ['cinematic', 'editing', 'style-transfer'],
    qualityNotes: 'Best-in-class frame-based video editing — edit one reference frame and the whole clip follows',
  },

  'runway-agent-2': {
    id: 'runway-agent-2',
    name: 'runway-agent-2',
    displayName: 'Runway Agent 2.0',
    description: 'Agentic video builder — describe an idea and Agent 2.0 strategizes and builds the full video',
    costPerSecond: 0.1,
    maxDuration: 30,
    family: 'runway',
    tier: 'premium',
    specialization: 'agentic',
    strengths: ['End-to-end agentic generation', 'Creative strategy', 'Brief-to-video', 'Multi-step planning'],
    weaknesses: ['Single-shot output (no multi-turn)', 'Premium pricing'],
    bestFor: ['quick-create', 'brief', 'agentic', 'concept-to-video', 'first-draft'],
    specialties: ['Agentic video creation', 'Creative brief interpretation', 'Full-video generation'],
    limitations: ['Single-shot only', 'Direct Runway API required'],
    visualCategory: ['cinematic', 'agentic', 'creative'],
    qualityNotes: 'Analyzes your brief and builds a first-draft video end-to-end with creative strategy built in',
  },

  'runway-happy-horse-1': {
    id: 'runway-happy-horse-1',
    name: 'runway-happy-horse-1',
    displayName: 'Runway Happy Horse 1.0',
    description: 'New Runway-native creative video model — expressive, playful, and highly stylized motion',
    costPerSecond: 0.08,
    maxDuration: 10,
    family: 'runway',
    tier: 'premium',
    strengths: ['Expressive motion', 'Stylized output', 'Creative character animation', 'Playful aesthetics'],
    weaknesses: ['Specialized creative style', 'Requires direct API key'],
    bestFor: ['creative', 'stylized', 'expressive', 'character-animation', 'playful', 'artistic'],
    specialties: ['Expressive character motion', 'Stylized creative content', 'Playful animated aesthetics'],
    limitations: ['Distinctly creative style — less neutral than Gen-4', 'Direct Runway API required'],
    visualCategory: ['creative', 'stylized', 'character-animation'],
    qualityNotes: 'Runway-native creative model with distinctly expressive, stylized motion aesthetics',
  },
