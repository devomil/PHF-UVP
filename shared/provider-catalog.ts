...
export const VIDEO_PROVIDER_CATALOG: ProviderCatalogEntry[] = [
  ...
  },
  {
    ...
    name: 'Runway Gen-3',
    family: 'Runway',
    description: 'RunwayML\'s flagship Gen-3 model. Industry-leading prompt comprehension, cinematic quality, and reliable multi-subject scenes for professional video production.',
    capabilities: ['T2V', 'I2V'],
    maxDuration: 10,
    costTier: 'premium',
    type: 'video',
