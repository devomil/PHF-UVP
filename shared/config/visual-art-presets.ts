...
export const VISUAL_ART_PRESETS: Record<string, VisualArtPreset> = {
  '3d-illustration': {
    ...
    providerHierarchy: {
      ...
      fallback: ['kling-2.6-pro', 'sora-2', 'veo-3.1'],
  ...
  'cinematic-realism': {
    ...
    providerHierarchy: {
      primary: 'veo-3.1',
      fallback: ['sora-2', 'kling-2.6-pro', 'kling-2.6'],
      reason: 'Veo 3.1 leads in photorealistic film-grade 4K output via PiAPI. Sora 2 and Kling 2.6 Pro are strong alternates for realism.',
    },
    sceneTypeProviderMap: {
      'hook': ['veo-3.1', 'sora-2', 'kling-2.6-pro'],
      'hero': ['veo-3.1', 'sora-2', 'kling-2.6-pro'],
      'testimonial': ['veo-3.1', 'kling-2.1-master', 'sora-2'],
      'human_subjects': ['veo-3.1', 'kling-2.1-master', 'sora-2'],
      'intro': ['veo-3.1', 'sora-2', 'kling-2.6-pro'],
      'solution': ['veo-3.1', 'sora-2', 'kling-2.6-pro'],
      'benefit': ['veo-3.1', 'sora-2', 'kling-2.6-pro'],
      'explanation': ['sora-2', 'veo-3.1', 'kling-2.6-pro'],
      'standard': ['veo-3.1', 'sora-2', 'kling-2.6-pro'],
      'problem': ['veo-3.1', 'sora-2', 'kling-2.6-pro'],
      'cta': ['veo-3.1', 'sora-2', 'kling-2.6-pro'],
      'product': ['veo-3.1', 'kling-2.6-pro', 'sora-2'],
      'proof': ['sora-2', 'veo-3.1', 'kling-2.6-pro'],
      'broll': ['veo-3.1', 'sora-2', 'kling-2.6'],
      'b-roll': ['veo-3.1', 'sora-2', 'kling-2.6'],
      'atmosphere': ['veo-3.1', 'sora-2', 'kling-2.6'],
      'transition': ['veo-3.1', 'sora-2', 'kling-2.6-pro'],
      'brand': ['veo-3.1', 'sora-2', 'kling-2.6-pro'],
      'motion-control': ['kling-2.6-motion-control-pro', 'veo-3.1', 'kling-2.6-pro'],
    },
    generationStrategy: 'i2v',
    globalStyleNotes: 'Photorealistic film-grade cinematography • Natural lighting with cinematic color grading • Teal and orange color palette • Anamorphic lens characteristics • Shallow depth of field • 35mm film look • No stylized or illustrated elements • No text, no signs, no labels, no readable words anywhere in the scene',
    cameraMotionHints: 'slow dolly, smooth tracking, elegant crane, steady push-in',
    styleMarkerPrefix: 'Photorealistic cinematic',
    styleKeywords: ['cinematic', 'photorealistic', 'film-grade', 'realistic'],
  },
  ...
  '2d-line-art': {
    ...
    providerHierarchy: {
      ...
      fallback: ['sora-2', 'veo-3.1', 'kling-2.6'],
      reason: 'Kling handles stylized flat aesthetics better than Runway for illustrated styles.',
    },
    sceneTypeProviderMap: {
      'hook': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'hero': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'testimonial': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'human_subjects': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'intro': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'solution': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'benefit': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'explanation': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'standard': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'problem': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'cta': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'product': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'proof': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'broll': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'b-roll': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'atmosphere': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'transition': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'brand': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'motion-control': ['kling-2.6-motion-control-pro', 'kling-2.6-pro', 'kling-2.6'],
    },
    generationStrategy: 'i2v',
  ...
  collage: {
    ...
    providerHierarchy: {
      primary: 'kling-2.6-pro',
      fallback: ['sora-2', 'veo-3.1', 'kling-2.6'],
      reason: 'Mixed media texture styles perform best on Kling. Sora 2 and Veo 3.1 as fallbacks.',
    },
    sceneTypeProviderMap: {
      'hook': ['kling-2.6-pro', 'sora-2', 'veo-3.1'],
      'hero': ['kling-2.6-pro', 'sora-2', 'veo-3.1'],
      'testimonial': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'human_subjects': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'intro': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'solution': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
  ...
  claymation: {
    ...
    sceneTypeProviderMap: {
      'hook': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'hero': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'testimonial': ['kling-2.6-pro', 'sora-2-pro', 'kling-2.6'],
      'human_subjects': ['kling-2.6-pro', 'sora-2-pro', 'kling-2.6'],
      'intro': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'solution': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'benefit': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'explanation': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
  ...
  'neon-futuristic': {
    ...
    providerHierarchy: {
      primary: 'kling-2.6-pro',
      fallback: ['veo-3.1', 'sora-2', 'kling-2.6'],
      reason: 'Kling 2.6 Pro handles cyberpunk holographic glow and high-contrast lighting well. Veo 3.1 and Sora 2 as strong secondaries.',
    },
    sceneTypeProviderMap: {
      'hook': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'hero': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'testimonial': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'human_subjects': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'intro': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'solution': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'benefit': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'explanation': ['kling-2.6-pro', 'sora-2', 'veo-3.1'],
      'standard': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'problem': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'cta': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'product': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'proof': ['kling-2.6-pro', 'sora-2', 'veo-3.1'],
      'broll': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'b-roll': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'atmosphere': ['kling-2.6-pro', 'veo-3.1', 'kling-2.6'],
      'transition': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'brand': ['kling-2.6-pro', 'veo-3.1', 'sora-2'],
      'motion-control': ['kling-2.6-motion-control-pro', 'kling-2.6-pro', 'veo-3.1'],
    },
    generationStrategy: 'i2v',
  ...
  'scientific-medical': {
    ...
    providerHierarchy: {
      primary: 'sora-2',
      fallback: ['kling-2.6-pro', 'veo-3.1', 'kling-2.6'],
    ...
    sceneTypeProviderMap: {
      'hook': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'hero': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'testimonial': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'human_subjects': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'intro': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'solution': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'benefit': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'explanation': ['sora-2', 'veo-3.1', 'kling-2.6-pro'],
      'standard': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'problem': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'cta': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'product': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'proof': ['sora-2', 'veo-3.1', 'kling-2.6-pro'],
      'broll': ['sora-2', 'veo-3.1', 'kling-2.6-pro'],
      'b-roll': ['sora-2', 'veo-3.1', 'kling-2.6-pro'],
      'atmosphere': ['sora-2', 'veo-3.1', 'kling-2.6-pro'],
      'transition': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'brand': ['sora-2', 'kling-2.6-pro', 'veo-3.1'],
      'motion-control': ['kling-2.6-motion-control-pro', 'sora-2', 'kling-2.6-pro'],
    },
    generationStrategy: 'i2v',
...
export const AUTO_PROVIDER_HIERARCHY: ProviderHierarchy = {
  primary: 'kling-2.6-pro',
  fallback: ['veo-3.1', 'sora-2', 'kling-2.6'],
  reason: 'Balanced default — Kling 2.6 handles most styles well, Veo 3.1 and Sora 2 as PiAPI-routed fallbacks',
};
