...
export const VISUAL_ART_PRESETS: Record<string, VisualArtPreset> = {
  ...
  'cinematic-realism': {
    ...
    sceneTypeProviderMap: {
      'hook': ['runway-gen4', 'sora-2', 'veo-3'],
      'hero': ['runway-gen4', 'sora-2', 'veo-3'],
      'testimonial': ['runway-gen4', 'kling-2.1-master', 'sora-2'],
      'human_subjects': ['runway-gen4', 'kling-2.1-master', 'sora-2'],
      'intro': ['runway-gen4', 'sora-2', 'veo-3'],
      'solution': ['runway-gen4', 'sora-2', 'kling-2.6-pro'],
      'benefit': ['runway-gen4', 'sora-2', 'veo-3'],
      'explanation': ['sora-2', 'runway-gen4', 'veo-3'],
      'standard': ['runway-gen4', 'sora-2', 'kling-2.6-pro'],
      'problem': ['runway-gen4', 'sora-2', 'veo-3'],
      'cta': ['runway-gen4', 'sora-2', 'kling-2.6-pro'],
      'product': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'proof': ['sora-2', 'runway-gen4', 'veo-3'],
      'broll': ['runway-gen4', 'veo-3', 'sora-2'],
      'b-roll': ['runway-gen4', 'veo-3', 'sora-2'],
      'atmosphere': ['runway-gen4', 'veo-3', 'sora-2'],
      'transition': ['runway-gen4', 'sora-2', 'kling-2.6-pro'],
      'brand': ['runway-gen4', 'sora-2', 'kling-2.6-pro'],
      'motion-control': ['kling-2.6-motion-control-pro', 'runway-gen4', 'kling-2.6-pro'],
    },
    generationStrategy: 'i2v',
  ...
  collage: {
    ...
    sceneTypeProviderMap: {
      'hook': ['kling-2.6-pro', 'runway-gen4', 'sora-2'],
      'hero': ['kling-2.6-pro', 'runway-gen4', 'sora-2'],
      'testimonial': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'human_subjects': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'intro': ['kling-2.6-pro', 'kling-2.6', 'runway-gen4'],
      'solution': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'benefit': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'explanation': ['kling-2.6-pro', 'sora-2', 'kling-2.6'],
      'standard': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
  ...
  'neon-futuristic': {
    ...
    sceneTypeProviderMap: {
      'hook': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'hero': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'testimonial': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'human_subjects': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'intro': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'solution': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'benefit': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'explanation': ['runway-gen4', 'sora-2', 'kling-2.6-pro'],
      'standard': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'problem': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'cta': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'product': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'proof': ['runway-gen4', 'sora-2', 'kling-2.6-pro'],
      'broll': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'b-roll': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'atmosphere': ['runway-gen4', 'veo-3', 'kling-2.6-pro'],
      'transition': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'brand': ['runway-gen4', 'kling-2.6-pro', 'sora-2'],
      'motion-control': ['kling-2.6-motion-control-pro', 'runway-gen4', 'kling-2.6-pro'],
    },
    generationStrategy: 'i2v',
  ...
  watercolor: {
    ...
    sceneTypeProviderMap: {
      ...
      'broll': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'b-roll': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'atmosphere': ['kling-2.6-pro', 'veo-3', 'kling-2.6'],
      'transition': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'brand': ['kling-2.6-pro', 'kling-2.6', 'sora-2'],
      'motion-control': ['kling-2.6-motion-control-pro', 'kling-2.6-pro', 'kling-2.6'],
    },
  ...
  'scientific-medical': {
    ...
    sceneTypeProviderMap: {
      'hook': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'hero': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'testimonial': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'human_subjects': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'intro': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'solution': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'benefit': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'explanation': ['sora-2', 'veo-3', 'kling-2.6-pro'],
      'standard': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'problem': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'cta': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'product': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'proof': ['sora-2', 'veo-3', 'kling-2.6-pro'],
      'broll': ['sora-2', 'veo-3', 'kling-2.6-pro'],
      'b-roll': ['sora-2', 'veo-3', 'kling-2.6-pro'],
      'atmosphere': ['sora-2', 'veo-3', 'kling-2.6-pro'],
      'transition': ['sora-2', 'kling-2.6-pro', 'veo-3'],
      'brand': ['sora-2', 'kling-2.6-pro', 'veo-3'],
