...
interface AskSuzziePanelProps {
  ...
  onSuggestArtStyle?: (artStyle: { id: string; name: string; rationale?: string } | null) => void;
  zIndex?: number;
}
              ...
              {msg.suggestedArtStyle && (
                ...
                >
                  ...
                  <div className="px-2.5 py-2">
                    ...
                    {msg.suggestedArtStyle.rationale && (
                      <p className="mt-1 text-[10px] leading-relaxed" style={{ color: "rgba(251,191,36,0.7)" }}>
                        {msg.suggestedArtStyle.rationale}
                      </p>
                    )}
                  </div>
