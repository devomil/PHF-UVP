...
export const VIDEO_PROVIDERS: ProviderInfo[] = [
  ...
  },
  {
    id: 'runway-4.5',
    name: 'Runway 4.5',
    description: 'Latest Runway — photorealistic, best creative control',
    bestFor: ['cinematic', 'premium', 'hero-shots', 'photorealistic'],
    icon: '👑',
    color: 'amber',
    supportsI2I: false,
    supportsI2V: true,
  ...
  },
  {
    id: 'runway-gen4',
    name: 'Runway Gen-4',
    description: 'Advanced creative control, dramatic storytelling',
    bestFor: ['cinematic', 'dramatic', 'storytelling'],
    icon: '🎬',
    color: 'blue',
    supportsI2I: false,
    supportsI2V: true,
  ...
  },
  {
    ...
    description: 'Enhanced motion quality, cinematic composition',
    bestFor: ['cinematic', 'creative', 'premium'],
    icon: '✨',
    color: 'purple',
    supportsI2I: false,
    supportsI2V: true,
  ...
  },
  {
    id: 'runway-act-two',
    name: 'Runway Act Two',
    description: 'Character performance, acting, emotional expression',
    bestFor: ['character', 'acting', 'emotional', 'performance'],
    icon: '🎭',
    color: 'pink',
    supportsI2I: false,
    supportsI2V: true,
  ...
  },
  {
    ...
    description: 'Frame-based video editing — re-style any existing clip',
    bestFor: ['video-editing', 'style-transfer', 'restyle', 'lighting'],
    icon: '✏️',
    color: 'purple',
    supportsI2I: false,
    supportsI2V: false,
  ...
  },
  {
    ...
    description: 'Agentic — describe a brief and AI builds the whole video',
    bestFor: ['agentic', 'brief', 'concept-to-video', 'quick-create'],
    icon: '🤖',
    color: 'indigo',
    supportsI2I: false,
    supportsI2V: true,
  ...
  },
  {
    ...
    description: 'Expressive, stylized creative motion — playful and artistic',
    bestFor: ['creative', 'stylized', 'expressive', 'character-animation', 'artistic'],
    icon: '🐴',
    color: 'amber',
    supportsI2I: false,
    supportsI2V: true,
